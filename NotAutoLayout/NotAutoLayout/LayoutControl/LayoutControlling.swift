...
extension NotAutoLayoutContainer where Containee: UIView {
	...
	public func layout(_ subview: UIView, by making: (_ layoutMaker: LayoutMaker<LayoutProperty.Initial>) -> LayoutMaker<IndividualLayout>) {
...
extension NotAutoLayoutContainer where Containee: UIView {
	...
	public func makeLayout(_ making: (LayoutMaker<LayoutProperty.Initial>) -> LayoutMaker<IndividualLayout>) -> IndividualLayout {
		
		let maker = LayoutMaker(parentView: self.body, didSetProperty: LayoutProperty.Initial())
