...
extension LayoutEditor {
	...
	public typealias AdditionalFloatEvaluation = (_ frame: CGRect, _ parameter: ViewFrameProperty) -> CGFloat
	public typealias AdditionalPointEvaluation = (_ frame: CGRect, _ parameter: ViewFrameProperty) -> CGPoint
	public typealias AdditionalSizeEvaluation = (_ frame: CGRect, _ parameter: ViewFrameProperty) -> CGSize
	
	public typealias AdditionalProcess = (_ view: UIView, _ frame: CGRect, _ parameter: ViewFrameProperty) -> Void
